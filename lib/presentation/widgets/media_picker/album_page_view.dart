import 'package:appturista/presentation/widgets/media_picker/image_picker_view.dart';
import 'package:appturista/presentation/widgets/media_picker/media_picker.dart';
import 'package:appturista/presentation/widgets/media_picker/photo_provider.dart';
      ...
      body: !_openFolders
          ? TabBarView(
              ...
              children: [
                assetsPathEntity != null
                    ? ImagePickerView(
                        assetCountToDisplay: assetsPathEntity!.assetCount,
                        axis: Axis.vertical,
                        // extraOption: false,
                        gridDelegate:
                ...
                assetsPathEntity != null
                    ? ImagePickerView(
                        ...
                        path:
                            assetsPathEntity?.copyWith(type: RequestType.video),
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                return InkWell(
                  ...
                  onTap: () {
                    setState(() {
                      assetsPathEntity = photoProvider.assetPathList[index];
                      _openFolders = !_openFolders;
                      _indexTabBar = 0;
                    });
                  },
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                '${photoProvider.assetPathList[index].assetCount.toString()} archivos',
                                style: const TextStyle(
